...
<p align="center">
	<a href="https://github.com/freemind-lj/caddy/actions?query=workflow%3ACross-Platform"><img src="https://github.com/freemind-lj/caddy/workflows/Cross-Platform/badge.svg"></a>
	<a href="https://pkg.go.dev/github.com/freemind-lj/caddy/v2"><img src="https://img.shields.io/badge/godoc-reference-%23007d9c.svg"></a>
	<br>
	<a href="https://twitter.com/caddyserver" title="@caddyserver on Twitter"><img src="https://img.shields.io/badge/twitter-@caddyserver-55acee.svg" alt="@caddyserver on Twitter"></a>
	<a href="https://caddy.community" title="Caddy Forum"><img src="https://img.shields.io/badge/community-forum-ff69b4.svg" alt="Caddy Forum"></a>
	<a href="https://sourcegraph.com/github.com/freemind-lj/caddy?badge" title="Caddy on Sourcegraph"><img src="https://sourcegraph.com/github.com/freemind-lj/caddy/-/badge.svg" alt="Caddy on Sourcegraph"></a>
</p>
<p align="center">
	<a href="https://github.com/freemind-lj/caddy/releases">Releases</a> ·
...
```bash
$ git clone "https://github.com/freemind-lj/caddy.git"
$ cd caddy/cmd/caddy/
$ go build
```
...
3. Copy [Caddy's main.go](https://github.com/freemind-lj/caddy/blob/master/cmd/caddy/main.go) into the empty folder. Add imports for any custom plugins you want to add.
4. Initialize a Go module: `go mod init caddy`
5. (Optional) Pin Caddy version: `go get github.com/freemind-lj/caddy/v2@version` replacing `version` with a git tag or commit.
...
Please use our [issue tracker](https://github.com/freemind-lj/caddy/issues) only for bug reports and feature requests, i.e. actionable development items (support questions will usually be referred to the forums).
