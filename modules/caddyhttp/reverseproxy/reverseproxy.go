...
type Handler struct {
	...
	// (see https://github.com/freemind-lj/caddy/issues/1460)
...
func (h *Handler) Cleanup() error {
	// TODO: Close keepalive connections on reload? https://github.com/freemind-lj/caddy/pull/2507/files#diff-70219fd88fe3f36834f474ce6537ed26R762
...
func (h *Handler) reverseProxy(rw http.ResponseWriter, req *http.Request, di DialInfo, next caddyhttp.Handler) error {
	...
	// (see https://github.com/freemind-lj/caddy/issues/3556 for use case and nuances)
